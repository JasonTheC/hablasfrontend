...
EPUB_DIR = Path("/media/nas/ms_copy/CarrierTech/Hablas/epub")
COVERS_DIR = Path("/media/nas/ms_copy/CarrierTech/Hablas/covers")
DEFAULT_COVER = "/media/nas/ms_copy/CarrierTech/Hablas/covers/default-cover.png"
